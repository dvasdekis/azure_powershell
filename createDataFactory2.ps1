...
# Set-Location $WorkFolder ; Write-Output "Williams,Jonathan" | Set-Content input/input.txt 

# Get-ChildItem input.txt -Recurse | Set-AzureStorageBlobContent -Container $ContainerName -Blob "input.csv" -Context $Context -Force
