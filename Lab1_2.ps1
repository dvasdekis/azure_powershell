### Process a batch job using HDInsight and Hive 
...
$HDIExternalIP = (Resolve-DNSName $HDInsightClusterName".azurehdinsight.net" | Select-Object IP4Address).IP4Address
New-AzureRmSqlServerFirewallRule -ResourceGroupName $ResourceGroupName -ServerName $SQLServerName -FirewallRuleName $HDInsightClusterName -StartIpAddress $HDIExternalIP -EndIPAddress $HDIExternalIP        
