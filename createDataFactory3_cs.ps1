...
Get-AzureRMDataFactorySlice -ResourceGroupName $ResourceGroupName -DatafactoryName $DataFActoryName -DatasetName "BlobTable" -StartDateTime (Get-Date "1/1/2017") -EndDateTime (Get-Date)

$DFRBlobTable = Get-AzureRMDataFactoryRun -ResourceGroupName $ResourceGroupName -DatafactoryName $DataFActoryName -DatasetName "BlobTable" -StartDateTime (Get-Date "1/1/2017")
Get-AzureRMDataFactorySlice -ResourceGroupName $ResourceGroupName -DatafactoryName $DataFActoryName -DatasetName "SQLTable" -StartDateTime (Get-Date "1/1/2017") -EndDateTime (Get-Date)

$DFRSQLTable = Get-AzureRMDataFactoryRun -ResourceGroupName $ResourceGroupName -DatafactoryName $DataFActoryName -DatasetName "SQLTable" -StartDateTime (Get-Date "1/1/2017")
