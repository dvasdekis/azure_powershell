...
$DL = New-AzureRmDataLakeStoreAccount -ResourceGroupName $ResourceGroupName -Name $DataLakeName -Location $Location 
...
Get-AzureRMDataFactorySlice -ResourceGroupName $ResourceGroupName -DatafactoryName $DataFActoryName -DatasetName "BlobInput" -StartDateTime (Get-Date "3/1/2017")

$DFRBlobInput = Get-AzureRMDataFactoryRun -ResourceGroupName $ResourceGroupName -DatafactoryName $DataFActoryName -DatasetName "BlobInput" -StartDateTime (Get-Date "3/1/2017")

Get-AzureRMDataFactorySlice -ResourceGroupName $ResourceGroupName -DatafactoryName $DataFActoryName -DatasetName "SQLOutput" -StartDateTime (Get-Date "3/1/2017")

$DFRSQLOutput = Get-AzureRMDataFactoryRun -ResourceGroupName $ResourceGroupName -DatafactoryName $DataFActoryName -DatasetName "SQLOutput" -StartDateTime (Get-Date "3/1/2017")

Get-AzureRMDataFactorySlice -ResourceGroupName $ResourceGroupName -DatafactoryName $DataFActoryName -DatasetName "SQLInput" -StartDateTime (Get-Date "3/1/2017")

$DFRSQLInput = Get-AzureRMDataFactoryRun -ResourceGroupName $ResourceGroupName -DatafactoryName $DataFActoryName -DatasetName "SQLInput" -StartDateTime (Get-Date "3/1/2017") 

Get-AzureRMDataFactorySlice -ResourceGroupName $ResourceGroupName -DatafactoryName $DataFActoryName -DatasetName "ADLOutput" -StartDateTime (Get-Date "3/1/2017") 

$DFRADLOutput = Get-AzureRMDataFactoryRun -ResourceGroupName $ResourceGroupName -DatafactoryName $DataFActoryName -DatasetName "ADLOutput" -StartDateTime (Get-Date "3/1/2017")
