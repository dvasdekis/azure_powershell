...
### Runbooks
$RunbookBlobOriginal = $workFolder + "runbookBLOBOriginal.ps1"
$RunbookBlob = $TempFolder + "runbookBLOB.ps1"
$RunbookBlobName = "runbookBLOB"
#####################
### Linked Services
...
## Log start time of script and create temp folder to do so
...
Write-Host "Create a Storage Account Container. I think containers hold permissions"
New-AzureStorageContainer -Name $ContainerName -Context $StorageAccountContext -Permission Container 

Write-Host "Create a certificate"
